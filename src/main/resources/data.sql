...
-- Company sample data
insert into companies( created_by, created_time, is_deleted, updated_by, updated_time, address1, address2, email,
                      enabled, establishment_date, phone, representative, state, title, zip)
VALUES (1, '2021-01-05 00:00:00', false, 1, '2021-01-05 00:00:00', '3073 Sumner Street', '', 'abc@fuji.com', true,
        '2020-01-05', '310-628-7886', 'John Fuji', 'CALIFORNIA', 'Fuji Holding', '91752');
